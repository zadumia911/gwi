...
@section('title','Employee Payment Edit') 
@section('content')
...
<div class="card">
    <!-- form start -->
    <form action="{{url('/admin/employee-payment/update')}}" method="POST" enctype="multipart/form-data" name="editForm">

      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="short-icon text-right">
            <a href="{{url('editor/brand/add')}}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
          </div>
        </div>
      </div>
    </div>
          ...
          <tr>
            ...
            <td class="action_button">
              <ul class="manage-btn-group">
                <li><a href="{{url('editor/brand/edit/'.$value->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a></li>
                <li>
                @if($value->status==1)
                ...
                @endif
                 <li>
                  <form action="{{url('editor/brand/delete')}}" method="POST">
                    @csrf
                    <input type="hidden" name="hidden_id" value="{{$value->id}}">

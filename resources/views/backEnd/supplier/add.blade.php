            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('supplier_name') ? ' is-invalid' : '' }}" id="supplier_name" name="supplier_name" placeholder="Enter Supplier Name ...." value="{{ old('supplier_name') }}" required/>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('supplier_address') ? ' is-invalid' : '' }}" id="supplier_address" value="{{ old('supplier_address') }}" name="supplier_address" />
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control {{ $errors->has('supplier_phone') ? ' is-invalid' : '' }}" id="supplier_phone" value="{{old('supplier_phone')}}" name="supplier_phone" />
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="email"  class="form-control {{ $errors->has('supplier_email') ? ' is-invalid' : '' }}" id="supplier_email" value="{{old('supplier_email')}}" name="supplier_email" />
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control {{ $errors->has('supplier_web') ? ' is-invalid' : '' }}" id="supplier_web" value="{{old('supplier_web')}}" name="supplier_web" />
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="number"  class="form-control {{ $errors->has('supplier_balance') ? ' is-invalid' : '' }}" id="supplier_balance" value="{{old('supplier_balance')}}" name="supplier_balance" required />

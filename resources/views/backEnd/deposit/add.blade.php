...
<div class="card">
    <!-- form start -->
    <form action="{{url('/admin/deposit/save')}}" method="POST" enctype="multipart/form-data">
    	@csrf
        <div class="card-body">
            <div class="row">
               <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"  class="myDate form-control {{ $errors->has('date') ? ' is-invalid' : '' }}" id="date" placeholder="Date" value="{{old('date')}}" name="date"/>
                        @if ($errors->has('date'))
                        <span class="invalid-feedback" role="alert">

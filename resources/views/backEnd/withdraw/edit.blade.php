...
@section('title','Bank Withdraw Edit') 
@section('content')
...
<div class="card">
    <!-- form start -->
    <form action="{{url('/admin/withdraw/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control {{ $errors->has('cheque_number') ? ' is-invalid' : '' }}" id="cheque_number" placeholder="Cheque Number" value="{{$edit_data->cheque_number}}" name="cheque_number"/>

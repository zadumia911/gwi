      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="short-icon text-right">
            <a href="{{url('admin/customer/collection/add')}}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> @if($value->status==1)
                ...
                @else
                <form action="{{url('admin/customer/collection/active')}}" method="POST">
                  @csrf
            ...
            <td class="action_button">
                 <li>
                  <form action="{{url('admin/customer/collection/delete')}}" method="POST">
                    @csrf
                    <input type="hidden" name="hidden_id" value="{{$value->id}}">

...
@section('title','Customer Collection') 
@section('content')
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <div class="page-title">
                    <h6>Customer Collection</h6>
              </div>
            </div>
            <div class="col-sm-6">
                <div class="short-icon text-right">
                    <a href="{{url('admin/customer/collection/manage')}}" class="btn btn-primary"><i class="fa fa-eye"></i> Manage</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="card">
    <!-- form start -->
    <form method="POST" action="{{url('admin/customer/collection/save')}}">
    @csrf      
        <div class="row">
          <div class="card-body">
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="customer_id" id="customer_id">
                      ...
                      @foreach($customers as $value)
                        <option value="{{$value->id}}"> {{$value->customer_name ,$value->customer_address, $value->customer_phone}}</option>
                      @endforeach
                  </select>
                </div>                
              </div>
